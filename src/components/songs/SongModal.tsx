...
import type { Song, SongStatus, SongCategory, CreateSongDto, TrackItem } from "@/types";
...
export function SongModal({ open, song, onClose, onSave }: Props) {
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      // Enviar category como undefined si está vacío, para no mandar string vacío a la API
